      ...
      <div style={{ background: '#fff', borderRadius: '20px 20px 0 0', padding: '16px', flex: 1 }}>
        {!searched ? (
          ...
          <>
            ...
            {posterData && (
              <PosterOverlay templateUrl={posterData.templateUrl} xMarkUrl={posterData.xMarkUrl} hotspots={posterData.hotspots} outOfStock={outOfStock} extraAvailableModels={posterData.extraAvailableModels} />
            )}
